<p>Hi {{ $user->name }},</p>
<p>We tried to process your subscription payment of <strong>{{ $payment->getFormattedTotal() }}</strong> on your card ending in <strong>{{ $payment->user->card_last_four }}</strong> but it was declined.</p>
