...
<div class="container content">
    ...
    <p>The following plugins are available as add-on plugins for Scroll Triggered Boxes, either free or with one of the <a href="{{ url('/pricing') }}">available plans</a>.</p>
